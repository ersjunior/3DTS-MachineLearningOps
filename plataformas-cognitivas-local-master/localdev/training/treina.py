...
if __name__ == "__main__":
    # Carrega os dados
    mydf = pd.read_csv('plataformas-cognitivas-local-master/datasets/BaseDefault01.csv')
    ...
    joblib.dump(clf, 'plataformas-cognitivas-local-master/localdev/models/modelo01.joblib')
    print("Modelo 01 (classificador) salvo com sucesso.")
    joblib.dump(rgs, 'plataformas-cognitivas-local-master/localdev/models/modelo02.joblib')
